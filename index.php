...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <!-- Gyűjtse össze a navigációs linkeket, űrlapokat és egyéb tartalmakat a váltáshoz -->
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Garázs <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="prereturncar.php">Bérelt jármű visszaadása</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading">C-rental Hungary</h1>
                            <p class="intro-text">
                                Online autókölcsönző szolgáltatás
                            </p>
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        <h3 style="text-align:center;">Elérhető autók</h3>
<br>
        <section class="menu-content">
            ...
            <h6> AC Díj: <?php echo ($ac_price ." Ft /1km" ." vagy " . $ac_price_per_day ." Ft /nap"); ?></h6>
            <!-- 
                <h6> Non-AC Díj: <?php echo ("Ft. " . $non_ac_price . "/km & Ft." . $non_ac_price_per_day . "/nap"); ?></h6>
            ...
            <?php }}
                ...
                ?>
<h1> Jelenleg nincs elérhető autó </h1>
                <?php
            }
            ?>                                   
        </section>
