...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    ?>
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center">Jelenleg bérelt járműve(k) leadása</h1>
                <p class="text-center">Reméljük, hogy elnyertük a tetszését.</p>
            </div>
        </div>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php
                                ...
                                ?></td>
                        <td><a href="returncar.php?id=<?php echo $row["id"]; ?>"> Leadás </a></td>
                    </tr>
                <?php } ?>
            </table>
        </div>
    ...
    ?>
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center">Önnek nincsen bérelt autója.</h1>
                <p class="text-center">Reméljük, hogy elnyertük a tetszését.</p>
            </div>
        </div>
