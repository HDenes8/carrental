<?php
include('login_client.php'); // Beleértve a bejelentkezési scriptet
...
<head>
    <title> Munkatárs Bejelentkezés | C-rental Hungary </title>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">C-rental Hungary - Munkatársi Panel </span>
            </h1>
            <br>
            <p class="text-center">Kérjük, jelentkezzen be folytatáshoz.</p>
        </div>
    </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="" method="POST">
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="client_username" type="text" name="client_username" placeholder="Felhasználónév" required="" autofocus="">
                        ...
                        <label style="margin-left: 5px;"><a href="clientsignup.php">Új fiók létrehozása.</a></label>
                    </form>
                </div>
            </div>
        </div>
