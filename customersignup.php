...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <p class="text-center">Kezdd el a regisztrációt, hozz létre egy ügyfélfiókot</p>
        </div>
    </div>
                    ...
                    <form role="form" action="customer_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_name"><span class="text-danger" style="margin-right: 5px;">*</span> Teljes név: </label>
                                <div class="input-group">
                                    <input class="form-control" id="customer_name" type="text" name="customer_name" placeholder="Teljes neved" required="" autofocus="">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="customer_username" type="text" name="customer_username" placeholder="Felhasználóneved" required="">
                                    <span class="input-group-btn">
                                        <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></label>
                                    </span>
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_phone"><span class="text-danger" style="margin-right: 5px;">*</span> Telefonszám: </label>
                                <div class="input-group">
                                    <input class="form-control" id="customer_phone" type="text" name="customer_phone" placeholder="Telefonszám" required="">
                                    <span class="input-group-btn">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_address"><span class="text-danger" style="margin-right: 5px;">*</span> Lakcím: </label>
                                <div class="input-group">
                                    <input class="form-control" id="customer_address" type="text" name="customer_address" placeholder="Lakcím" required="">
                                    <span class="input-group-btn">
                        ...
                        <label style="margin-left: 5px;"><a href="customerlogin.php">Van fiókod? Jelentkezz be.</a></label>
